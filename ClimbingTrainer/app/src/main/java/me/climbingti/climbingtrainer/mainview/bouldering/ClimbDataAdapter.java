 ...
 */
public class ClimbDataAdapter extends BaseExpandableListAdapter {

    private ArrayMap<Date, Collection> collectionArrayMap;
    private Context context;
    private DateConverter dateConverter;

    public ClimbDataAdapter(Context context, ArrayMap<Date, Collection> collectionArrayMap) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ClimbCollection child = (ClimbCollection) collectionArrayMap.valueAt(groupPosition);
        ClimbEntity entity = (ClimbEntity) child.get(childPosition);
        ...
        grade = (TextView) convertView.findViewById(R.id.listRow_textView_value);
